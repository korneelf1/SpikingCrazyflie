...
from pompdsac_policy import POMPDSACPolicy
...
from spikingActorProb import POMDPDActorProb
...
def test_sac(args: argparse.Namespace = get_args()) -> None:
    ...
    policy: POMPDSACPolicy = POMPDSACPolicy(
        actor=actor,

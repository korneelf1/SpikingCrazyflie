...
env = Monitor(env)
check_env(env)
env = make_vec_env(lambda: Learning2Fly(fast_learning=False), n_envs=12)

model = sb3.SAC("MlpPolicy", env, verbose=1,train_freq=1,gradient_steps=-1, buffer_size=int(3e6),)

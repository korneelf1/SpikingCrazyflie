python tianshou_l2f_ddpg.py --slope_schedule 'adaptive' --slope 2 --exploration-noise 'default'
python tianshou_l2f_ddpg.py --slope_schedule 'adaptive' --slope 2 --exploration-noise 'default'
python tianshou_l2f_ddpg.py --slope_schedule 'adaptive' --slope 2 --exploration-noise 'None'
python tianshou_l2f_ddpg.py --slope_schedule 'adaptive' --slope 2 --exploration-noise 'None'

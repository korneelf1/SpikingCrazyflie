...
python TD3BC_Online.py --slope 2 --hidden-sizes 256 128 --curriculum --slope_schedule 'adaptive' --scheduling_order 3 --bc-val 0.0 --jumpstart --wandb-project neurips_ablation --ablation "bc_val_0_jumpstart_true_no_preloa" --batch-size 2048 --buffer-size 25000 --n_rollouts_per_gather 5000 --epochs_per_gather 20 --max_epochs 500

# Configuration 3: Keep bc_val=0.2, drop jumpstart to False
echo "Running Configuration 3: bc_val=0.2, jumpstart=False"
python TD3BC_Online.py --slope 2 --hidden-sizes 256 128 --curriculum --slope_schedule 'adaptive' --scheduling_order 3 --bc-val 0.2 --wandb-project neurips_ablation --ablation "bc_val_0.2_jumpstart_false_no_preloa" --batch-size 2048 --buffer-size 25000 --n_rollouts_per_gather 5000 --epochs_per_gather 20 --max_epochs 500
